                ...
                <div class="bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-4">
                            <div>
                                <h3 class="text-lg font-semibold text-gray-900 mb-1">{{ $chat->title }}</h3>
                                <p class="text-sm text-gray-600">Dibuat oleh {{ $chat->creator->name }}</p>
                            </div>
                        ...
                        @if ($chat->description)
                            <p class="text-gray-700 text-sm mb-4">{{ $chat->description }}</p>
                        @endif
        ...
        @if ($showCreateModal)
            <div class="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
                <div class="bg-white rounded-lg p-6 w-full max-w-md">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Buat Chat Baru</h3>
