...
<x-chat-layout :title="'Kelola ' . $chat->title">
            ...
            <form wire:submit="updateChatInfo">
                <div class="grid grid-cols-1 gap-4 mb-6">
                    <div>
                        ...
                        <input 
                            wire:model="chat.title" 
                            type="text" 
                            id="title"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        >
                        @error('chat.title') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea 
                            wire:model="chat.description" 
                            id="description"
                            rows="3"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        ></textarea>
                        @error('chat.description') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
        ...
        <div class="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
            <div class="bg-white rounded-lg p-6 w-full max-w-md max-h-96 overflow-y-auto">
                ...
                <div class="flex justify-end space-x-3">
                    <button 
                        type="button"
                        wire:click="$set('showAddMemberModal', false)"
